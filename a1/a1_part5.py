...
def separate_colour_channels(rgb_pixels: list) -> dict:
    ...
    True
    """
    r = [rgb[0] for rgb in rgb_pixels]
    g = [rgb[1] for rgb in rgb_pixels]
    b = [rgb[2] for rgb in rgb_pixels]
    return {'r': r, 'g': g, 'b': b}
...
def calculate_median_colour(colour_channels: dict) -> tuple:
    ...
    (38, 71, 55)
    """
    r_median = int(median(colour_channels['r']))
    g_median = int(median(colour_channels['g']))
    b_median = int(median(colour_channels['b']))
